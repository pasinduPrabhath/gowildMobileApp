...
class MyTripsShowView extends StatefulWidget {
  MyTripsShowView({
    Key? key,
    required this.size,
    // email,
  ...
  @override
  State<MyTripsShowView> createState() => _MyTripsShowViewState();
}

class _MyTripsShowViewState extends State<MyTripsShowView> {
  String email = '';
      ...
      SizedBox(
        ...
        child: email.isEmpty // Check if the email is empty
            ...
            : FutureBuilder<List<Request>>(
                future: ClientAPI.getInterestedAprovedTrips(email),
